...
export class EditAccountComponent {
  ...
  SaveChanges(){
    if(this.edit_form.controls.password != null && this.edit_form.controls.password == this.edit_form.controls.confirmpassword) return;//Confirm password,if pass not presentddoesnt change
